      ...
      <div className="bg-white rounded-2xl max-w-lg w-full shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          <div className="space-y-2">
            ...
            >
              <option value="gemini-3.5-flash">Gemini 3.5 Flash (推奨・最高精度＆2段階推敲 / Đỉnh cao chính xác)</option>
              <option value="gemini-3.5-flash-lite">Gemini 3.5 Flash Lite (超高速・軽量版 / Siêu tốc độ 2秒)</option>
              <option value="gemini-3.6-flash">Gemini 3.6 Flash (最新プレビュー / Bản thử nghiệm)</option>
            </select>
          </div>
